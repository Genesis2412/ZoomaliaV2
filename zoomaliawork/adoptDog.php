                    ...
                    <?php
                        ...
                        else
                        {
                            ...
                            foreach($result as $final)
                            {
                                ...
                                if($final->Status == "InProgress")
                                {
                                    $view=$view.'<p align="center" style="color:#EB4A12;font-size:16px;"><strong>The dog has already been requested</strong></p>';
                                }
                                $view=$view.'<form action="viewPet.php" method="POST">';
                                $view=$view.'<input type="hidden" name="id" value="'.$final->DogId.'">';
                                if($final->Status != "InProgress")
                                {
